...
<div class="form-group">
  <label class="col-md-4 control-label" for="TEST">SELECCIONAR AL USUARIO</label>
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-4 control-label">PERMISOS DE ADMINISTRADOR:</label>
  <div class="col-md-8">
    <button id="OTORGAR" name="OTORGAR" class="btn btn-success">OTORGAR</button>
    <button id="REMOVER" name="REMOVER" class="btn btn-inverse">REMOVER</button>
  </div>
</div>


<div class="form-group">
  <label class="col-md-4 control-label">ELIMINAR USUARIO:</label>
  <div class="col-md-4">
